...
import sample.java.Model.Admin;
...
public class AdminDBOperations implements DBOperations {
    ...
    public String addOperation(Object obj) {
        ...
        try {
            ...
            PreparedStatement pstmt1 = con.prepareStatement(strQuery1);
    ...
    public ObservableList<Map> viewOperation() {
        ...
        ResultSet rs = null;
        try {
            String strQuery = "SELECT a.adminid, a.name, a.designation, a.phone, a.email, a.loginid, a.password FROM app_admin a";
